            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.costPrice.label" default="Cost Price" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productInstance, field: "costPrice")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.skus.label" default="Skus" /></td>
