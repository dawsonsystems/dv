                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="costPrice" title="${message(code: 'product.costPrice.label', default: 'Cost Price')}" />
                    ...
                    <g:each in="${productInstanceList}" status="i" var="productInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: productInstance, field: "costPrice")}</td>
